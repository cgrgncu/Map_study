...
target_end_lat=21;
    ...
    %--
    % 補充資訊
    ETOPO1_Taiwan_DEM.Description='來源:自「https://www.ngdc.noaa.gov/mgg/global/」下載的「ETOPO1_Bed_g_geotiff.tif」中萃取出台灣範圍內的資料。水平解析度:1-arc-minutes (~1.8 kilometers)，單位[度]，原點正向依照經緯度座標；高程解析度:整數，單位[公尺]，冰層下的基岩表面為原點，向上為正。';
